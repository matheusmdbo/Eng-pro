...
export default function ElevacaoMod({ onSave, user, UI }: any) {
  ...
  return (<ModuleWrap>
    <ModuleHeader icon="⤴" name="Sistema de Elevação" norma="FEM 2.131/132 · FEM 3-7" color="#f97583" user={user} moduleType="elevacao" onSave={() => onSave({ type: "elevacao", inp, res })} onLoad={handleLoad}>
