...
export default function GiroMod({ onSave, user, UI }: any) {
  ...
  return (<ModuleWrap>
    <ModuleHeader icon="↻" name="Sistema de Giro" norma="FEM 2.131/132 · FEM 3-7" color="#79c0ff" user={user} moduleType="giro" onSave={() => onSave({ type: "giro", inp, res })} onLoad={handleLoad}>
